...
function AdminFeedback() {
  ...
  const feedbacks = useSelector((state: RootState) => {
    const userFeedback = state.feedback.feedback.find(
        ...
        {feedbacks.map((feedback, index) => (
          <tbody key={index}>
            <tr className="border-2 border-gray-200 hover:bg-gray-50">
              <td className="px-6 py-4 text-left font-medium text-gray-700 border-2">
            ...
            <tr className="border-2 border-gray-200 hover:bg-gray-50">
              <td className="px-6 py-4 text-left font-medium text-gray-700 border-2">
                Do you find the reading experience on our website/app
                comfortable?
              </td>
              <td className="px-6 py-4 text-left text-gray-500">
                {feedback.input2}
            ...
            <tr className="border-2 border-gray-200 hover:bg-gray-50">
              <td className="px-6 py-4 text-left font-medium text-gray-700 border-2">
                Are the headlines of our articles clear and engaging?
              </td>
              <td className="px-6 py-4 text-left text-gray-500">
                {feedback.input3}
              </td>
            ...
            <tr className="border-2 border-gray-200 hover:bg-gray-50">
              <td className="px-6 py-4 text-left font-medium text-gray-700 border-2">
                How satisfied are you with the search functionality on our
                platform?
              </td>
              <td className="px-6 py-4 text-left text-gray-500">
                {feedback.input4}
