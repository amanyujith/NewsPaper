...
const Carousel = ()=>{
    ...
    useEffect (()=>{
        ...
        const Articles = async ()=>{
           ...
           try{
            ...
            const response = await axios.get(`https://newsapi.org/v2/everything?q=entertainment&language=${language}&sortBy=${sort}&apiKey=${apiKey}`);
    ...
    {articles &&
            articles.map((article, index) => (
              <div className="embla__slide bg-neutral-200 rounded-lg" key={index}>
               <div className="">
